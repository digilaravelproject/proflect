                    ...
                    <div class="mt-10 w-full rounded-3xl border border-white/10 bg-black/60 p-6 sm:p-8 lg:p-10 shadow-xl backdrop-blur">
                        <div class="grid gap-10 lg:grid-cols-2">
                            ...
                            <div class="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur">
                                ...
                                @if ($errors->any() && ! session('otp_sent'))
                                ...
                                @if ($warranty && ! session("warranty_check.{$warranty->id}.verified"))
                                    <form action="{{ route('warranty.check.verify') }}" method="POST" class="space-y-4" id="otpForm">
                                        @csrf
                                        ...
                                        <div>
                                            ...
                                            @if ($errors->has('otp'))
                                                <p class="mt-2 text-sm text-red-100">{{ $errors->first('otp') }}</p>
                                            @endif
                                        </div>
                                ...
                                @if ($warranty && session("warranty_check.{$warranty->id}.verified"))
                                    <div class="mt-6 rounded-2xl border border-white/10 bg-black/70 p-6 shadow-inner">
                                        ...
                                        <div class="mt-6 grid gap-6">
                                            <div class="relative mx-auto w-full max-w-full sm:max-w-[340px] h-[210px] overflow-hidden rounded-3xl border border-white/10 bg-gray-100 p-5 shadow-xl" style="background: #F3F4F6;">
                                                ...
                                                <div class="relative flex h-full flex-col items-center justify-center gap-2 text-center">
                                                    ...
                                                    <p class="text-xs text-slate-600">Expires <span class="font-semibold text-slate-800">{{ $warranty->warranty_date->copy()->addYear()->format('d/m/y') }}</span></p>
