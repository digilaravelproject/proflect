            ...
            <header class="relative">
                ...
                <div class="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-10 lg:px-8">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="hidden items-center gap-4 text-xs text-gray-200 md:flex">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('warranty.check') }}" class="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/5 px-4 py-2 text-xs font-medium text-white hover:bg-white/10 transition">
                                        CHECK WARRANTY
                                    </a>
                                    <a href="https://proflect.com.au/shop/" class="inline-flex items-center justify-center rounded-full border border-yellow-400 px-4 py-2 text-xs font-medium text-yellow-400 hover:bg-yellow-400 hover:text-black transition">
                                        STORE
                                    </a>
                                </div>
                            </div>
                    ...
                    <div id="mobileMenu" class="hidden mt-4 space-y-3 rounded-2xl border border-white/10 bg-black/60 p-4 text-sm text-gray-200 md:hidden">
                        ...
                        <a href="{{ route('warranty.check') }}" class="block rounded-lg border border-white/20 bg-white/5 px-4 py-2 text-center text-sm font-medium text-white hover:bg-white/10">CHECK WARRANTY</a>
                        <a href="https://proflect.com.au/shop/" class="block rounded-lg border border-yellow-400 bg-white/5 px-4 py-2 text-center text-sm font-medium text-yellow-400 hover:bg-yellow-400 hover:text-black">STORE</a>
                    </div>
                    ...
                    <div class="mt-10 rounded-3xl border border-white/10 bg-black/60 p-6 sm:p-8 lg:p-10 shadow-xl backdrop-blur">
                        <div class="grid gap-10 lg:grid-cols-2">
                            <div class="space-y-6">
                                ...
                                <p class="text-lg text-gray-200">Get in touch with the Proflect team today to discuss your vehicle’s paint protection.</p>
                                <p class="text-gray-300">Whether you have a question about our premium protective films or want a quote, just complete the form and we’ll be in touch.</p>
                            ...
                            <div class="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur">
                                ...
                                <form id="warrantyForm" action="{{ route('warranty.store') }}" method="POST" class="space-y-4">
                                    @csrf
                                    ...
                                    <label class="block">
                                        ...
                                        <input
                                            type="text"
                                            name="unique_number"
                                            value="{{ $nextWarrantyNumber ?? '10001' }}"
                                            readonly
                                    ...
                                    <label class="mt-4 flex items-start gap-3 text-xs text-gray-400">
                                        ...
                                        <span class="leading-tight">
                                            By submitting, you agree to our <a href="{{ route('terms') }}" class="text-yellow-300 hover:underline">terms and conditions</a>.
                                        </span>
                                    </label>
...
<div id="warrantyPreview" class="relative mx-auto mt-6 w-full max-w-full sm:max-w-[340px] min-h-[214px] overflow-hidden rounded-3xl border border-white/10 bg-slate-900 p-6 shadow-2xl" style="background: radial-gradient(circle at top, rgba(255,255,255,0.08), rgba(0,0,0,0.85));">
                                        <div class="absolute inset-0 opacity-30" style="background: linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(0,0,0,0.35) 55%, rgba(0,0,0,0.8) 100%);"></div>

                                        <div class="relative flex flex-col items-center gap-1 text-center">
                                            <p class="text-3xl font-black tracking-[0.3em] text-white">PROFLECT</p>
                                            <p class="text-sm tracking-widest text-gray-300" style="font-size: 10px !important;">PAINT PROTECTION</p>
                                            <p class="text-base tracking-widest text-gray-400" style="font-size: 10px !important;">WARRANTY</p>

                                            <p id="cardNumber" class="mt-2 text-4xl font-black tracking-[0.4em] text-yellow-400">{{ $nextWarrantyNumber ?? 'AUTOGEN' }}</p>

                                            <p class="mt-2 text-xs text-gray-200">Expires <span id="cardExpiry" class="font-semibold text-white">--/--/--</span></p>

                                            <!-- <p class="mt-3 text-xs text-gray-300">Please scan the QR code to register and activate your warranty.</p> -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                        ...
                                        >
                                            <svg id="spinner" class="hidden h-5 w-5 animate-spin text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="mt-6 text-xs text-gray-500">
                                    <p class="mb-2">Need help? Call us: <a href="tel:0400527840" class="text-yellow-300 hover:underline">0400 527 840</a></p>
                                    <p>Prefer email? <a href="mailto:info@proflect.com.au" class="text-yellow-300 hover:underline">info@proflect.com.au</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
